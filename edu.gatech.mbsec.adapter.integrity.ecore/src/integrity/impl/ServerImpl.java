 ...
 * <ul>
 *   <li>{@link integrity.impl.ServerImpl#getProject <em>Project</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServerImpl extends MinimalEObjectImpl.Container implements Server {
	...
	protected EClass eStaticClass() {
		return IntegrityPackage.Literals.SERVER;
	}
	...
	public EList<Project> getProject() {
		if (project == null) {
			project = new EObjectContainmentEList<Project>(Project.class, this, IntegrityPackage.SERVER__PROJECT);
		}
		return project;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IntegrityPackage.SERVER__PROJECT:
