...
<title>Integrity OSLC Adapter: Resource Shapes</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Integrity OSLC Adapter: Resource Shapes</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Resource Shapes </span>Integrity</h1>
		<br>
