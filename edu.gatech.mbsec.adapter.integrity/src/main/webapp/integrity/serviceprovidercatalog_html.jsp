...
<html>
	<head>
		...
		<title>Integrity OSLC Adapter: Service Provider Catalog</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							Integrity OSLC Adapter: Service Provider Catalog
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<p>Enables navigation to Service Provider for each Integrity Project.</p>
			...
			<% for (ServiceProvider s : catalog.getServiceProviders()) { %>
				<% if(s.getTitle() != null){ %>
						<h3>Service Provider for Integrity Project <%= s.getTitle() %></h3>
			<p><a href="<%= s.getAbout() %>">
                    <%= s.getAbout() %></a></p>
                 <% } %>	
			<% } %>	
