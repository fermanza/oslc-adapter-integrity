...
IntegrityItem item = (IntegrityItem)request.getAttribute("element");
String requestURL = (String)request.getAttribute("requestURL");
Map<String,String> fieldNameValueMap = (Map<String,String>)request.getAttribute("fieldNameValueMap");
...
<html>
	<head>
		...
		<title>Integrity OSLC Adapter: Integrity Item</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							Integrity OSLC Adapter: Integrity Item
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1><small>Integrity Item</small> <%= item.getID() %></h1>
			...
			<% for (String fieldname : fieldNameValueMap.keySet()) { %>		
				...
				<h2><small><%= fieldname + ": " + fieldValue%></small></h2>								
			<% } %>			
