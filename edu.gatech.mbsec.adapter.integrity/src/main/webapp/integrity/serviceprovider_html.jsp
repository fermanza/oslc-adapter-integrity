...
<html>
	<head>
		...
		<title>Integrity OSLC Adapter: Service Provider for <%= serviceProvider.getTitle() + "(" + serviceProvider.getIdentifier() + ")" %></title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="0" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							Integrity OSLC Adapter: Service Provider
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			<div id="page-index">
				...
				<h1>Service Provider for Project <%= serviceProvider.getTitle().replace("project", "") %></h1>
				...
				<% for (Service service : serviceProvider.getServices()) { %>
					<% if(service.getQueryCapabilities().length > 0){ %>	
                    	...
                    	<%= service.getQueryCapabilities()[0].getQueryBase() %></a></p>
					<% } %>	
				<% }%>	
			...
			<p><a href="<%= service.getAbout()  %>">
				...
				<!-- 
				<h2>HTML Forms for Creating Integrity Elements</h2>
				<% for (Service service : serviceProvider.getServices()) { %>	
					<% if(service.getCreationFactories().length > 0)
					  { %>							
