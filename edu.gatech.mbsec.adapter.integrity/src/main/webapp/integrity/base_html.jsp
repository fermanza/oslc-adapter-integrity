...
<%@ page import="edu.gatech.mbsec.adapter.integrity.resources.trs.Base" %>
<%@ page import="java.util.Collection" %>
<%
String bugzillaUri = (String) request.getAttribute("bugzillaUri");
Base base = (Base)request.getAttribute("base");

URI baseDocumentURI = (URI)request.getAttribute("baseDocumentURI");
%>
<html>
	<head>

		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<title>Integrity OSLC Adapter: Base</title>
	...
	<body onload="">
		...
		<div id="bugzilla-body">
			...
			<% if(!base.getCutoffEvent().toString().equals("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil")) { %>
			<h2><small>Cut off Event: <a href="<%= base.getCutoffEvent() %>">
                    	<%= base.getCutoffEvent() %></a></small></h2>
			<% } else{ %>	
				<h2><small>Cut off Event: none</small></h2>
			<% } %>
