...
URI changeLogURI = (URI)request.getAttribute("changeLogURI");

URI changeLogDocumentURI = (URI)request.getAttribute("changeLogDocumentURI");
%>
<html>
	<head>

		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<title>Integrity OSLC Adapter: Change Log</title>
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							Integrity OSLC Adapter: Change Log
						</p>
					</td>
					<td id="information">
