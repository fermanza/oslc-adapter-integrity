...
@OslcService(Constants.INTEGRITY_SYSTEMELEMENT_DOMAIN)
@Path("{projectID}/systemelements")
public class IntegritySystemElementService {
	@Context
	...
	@OslcQueryCapability(title = "Integrity SystemElement Query Capability",label = "Integrity SystemElement Catalog Query",resourceShape = OslcConstants.PATH_RESOURCE_SHAPES+ "/" + Constants.PATH_INTEGRITY_SYSTEMELEMENT,resourceTypes = { Constants.TYPE_INTEGRITY_SYSTEMELEMENT },usages = { OslcConstants.OSLC_USAGE_DEFAULT })
	@GET
	@Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
	public List<IntegritySystemElement> getSystemElements(
		...
		List<IntegritySystemElement> oslcResources = IntegrityServerResources.getSystemElementsInProject(projectID);
		return oslcResources;
	}
	@GET
	@Produces(MediaType.TEXT_HTML)
	public void getHtmlSystemElements(@PathParam("projectID") final String projectID) {
		while(!IntegrityManager.serverResourcesReadFlag.getValue()){
			System.out.println("WAITING FOR ADAPTER TO FINISH SCANNING INTEGRITY SERVER");
			try {
				Thread.sleep(3000);
		...
		if (oslcResources != null) {
			...
			httpServletRequest.setAttribute("itemTypeName", "SystemElement");
	...
	@Path("{uri}")
	@Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
	public Response getSystemElement(
		@PathParam("projectID") final String projectID,
		...
		IntegritySystemElement oslcResource = IntegrityServerResources.getSystemElementByURI(projectID + "/systemelements/" + ID);
	...
	@Path("{uri}")
	@Produces(MediaType.TEXT_HTML)
	public void getHtmlSystemElement(
		@PathParam("projectID") final String projectID,
		@PathParam("uri") final String ID)
