...
public class RDFVocabularyService {
	...
	public void getRDFVocabulary()
			...
			RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/rdfvocabulary/integrityRDFVocabulary.rdf");
			try {
	...
	public void getHtmlRDFVocabulary() throws OslcCoreApplicationException, URISyntaxException {
		...
		RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/rdfvocabulary/integrityRDFVocabulary.jsp");
		try {
			rd.forward(httpServletRequest, httpServletResponse);
		} catch (Exception e) {
			e.printStackTrace();
