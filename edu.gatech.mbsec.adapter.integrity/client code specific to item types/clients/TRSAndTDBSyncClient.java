...
//				.readEntity(TrackedResourceSet.class);
		...
		TrackedResourceSet trackedResourceSet = IntegrityClientUtil.getTrackedResourceSetResource(trsURI);
...
//		Base base = baseResponse.readEntity(Base.class);
		...
		Base base = IntegrityClientUtil.getBaseResource(baseURI);
		...
		getChangeEventsFromChangeLogs(changeEvents, changeLog);
...
//					.readEntity(ChangeLog.class);
			...
			ChangeLog previousChangeLog = IntegrityClientUtil.getChangeLogResource(previousChangeLogURI);
...
//				System.out.println(changedResourceResponse.getStatus());
				...
				// get changed/new Integrity resource
				AbstractResource integrityResource = GeneratedIntegrityClientUtil.getIntegrityResource(changedResourceURI);
